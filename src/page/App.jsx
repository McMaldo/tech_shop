  ...
  return (
    ...
    <div className='z-4 w-full h-full relative flex flex-col items-center customScroll'>
      ...
      <main className='w-full relative h-screen select-none'>
        ...
        <section className={`relative w-full h-full p-6 flex flex-col items-center gap-4 bg-[url('/img/razer/razer-zzz.webp')] bg-cover bg-center bg-no-repeat`}>
        ...
        <section className={`w-full h-full p-6 flex flex-col items-center gap-10 bg-[url('/img/razer/headset/razer-blackshark-v3-line-homepage-large-2x.webp')] bg-cover bg-center bg-no-repeat`}>
